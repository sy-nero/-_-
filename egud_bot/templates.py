...
def _grant(business_name, association_name, sender_name,
    ...
    subject = (f"{business_name}, משהו שיכול להתאים לעסק שלכם" if business_name
               else "משהו שיכול להתאים לעסק שלכם")
    text = (
        f"שלום,\n\n"
        f"שמי {sender_name}, מ{association_name}.\n\n"
        f"{opener}, כי משהו שהגיע אלינו יכול להתאים לכם ממש.\n\n"
        ...
        f"אנחנו באיגוד מרכזים קבוצה של בעלי עסקים מהמגזר שמגישים יחד, וככל שהקבוצה "
        f"גדולה יותר, כך התנאים והליווי טובים יותר לכולם. המועד האחרון להגשה הוא "
        f"{GRANT_DEADLINE}.\n\n"
        f"אם זה מעניין אתכם, תשיבו לי לכאן עם שם וטלפון ואחזור אליכם אישית.\n\n"
        f"תודה,\n{sender_name}\n{association_name}\n"
    )
    p = "margin:0 0 14px;"
    html = f"""<!DOCTYPE html>
...
<body style="margin:0;padding:0;background:#ffffff;">
  <div dir="rtl" style="direction:rtl;text-align:right;max-width:600px;margin:0 auto;
    ...
    <p style="{p}">שלום,</p>
    <p style="{p}">שמי {sender_name}, מ{association_name}.</p>
    <p style="{p}">{opener}, כי משהו שהגיע אלינו יכול להתאים לכם ממש.</p>
    <p style="{p}">יש עכשיו מענק ממשלתי חדש למחשוב ואוטומציה בעסקים
      ({GRANT_NAME} של משרד הכלכלה): המדינה מחזירה עד 35 אחוז מהעלות, עד 350 אלף
      שקל, על מערכות ניהול, מכירות, מלאי, תוכנה וציוד.</p>
    <p style="{p}">אנחנו באיגוד מרכזים קבוצה של בעלי עסקים מהמגזר שמגישים יחד, וככל
      שהקבוצה גדולה יותר, כך התנאים והליווי טובים יותר לכולם. המועד האחרון להגשה
      הוא {GRANT_DEADLINE}.</p>
    <p style="{p}">אם זה מעניין אתכם, תשיבו לי לכאן עם שם וטלפון ואחזור אליכם אישית.</p>
    <p style="margin:0 0 4px;">תודה,</p>
    <p style="margin:0;">{sender_name}<br>{association_name}</p>
  </div>
</body></html>"""
