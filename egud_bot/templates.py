...
# המטרה היחידה של המייל: שהסוכן ישיב אם שיתוף הפעולה מעניין אותו. אין בו
# עמלה, אחוזים, בקשת פגישה -- ואין בו בקשה למספר טלפון: בפנייה ראשונה
# לאדם שלא מכיר אותנו, בקשת פרט ליצירת קשר היא מחסום מיותר. תשובה במייל
# היא הצעד הקטן ביותר שאפשר לבקש.
