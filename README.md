...
המייל נפתח ב**המלצה אמיתית** שהבוט מצא על הסוכן (ביקורות Google, עמוד המלצות
באתר, או חיפוש), וממשיך ב**נימוק למה דווקא הוא** — שנגזר מתוכן ההמלצות
(האם הממליצים הם בעלי עסקים, האם זה ליווי שוטף). לא נמצאה המלצה? המשפט יורד,
ולא נכתב משהו שלא נבדק. כל המלצה נשמרת עם קישור לאימות ידני לפני השליחה.
