...
הקמפיין רץ כבדיקת A/B: נוסח א׳ פותח שיחה בלי לחשוף את ההצעה ("חיפשתי רואה
חשבון באזור ירושלים ונתקלתי בך"), ונוסח ב׳ מציג אותה מיד (CRM ל-3 חודשים
במתנה + 10% עמלה). כל נוסח נשלח לקבוצת נמענים אחרת, בלי חפיפה, ושניהם
מבקשים דבר אחד: להשאיר טלפון. `report` משווה את אחוזי התגובה, וכל תשובה
נרשמת עם `replied`.
